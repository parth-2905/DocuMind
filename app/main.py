...
async def query(req: QueryRequest):
    ...
    top_k_map = {"brief": 5, "medium": 8, "detailed": 12}
    ...
    async def process():
        ...
        top_chunks = reranker.rerank(req.query, fused, top_k=top_k)
        return generate_response(req.query, top_chunks, llm, notes_mode=req.notes_mode)
